package com.example.main_menu201b212;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId())
        {
            ...
            case R.id.snkrt:
                ...
                sharedPreferences.edit().putString("title","Sanskrit").apply();
                return true;
            default:
                return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=this.getSharedPreferences("com.example.main_menu201b212",0);
